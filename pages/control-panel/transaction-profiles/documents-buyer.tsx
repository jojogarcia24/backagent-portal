...
const SALE_BUYER_ACTIVE_DISPLAYED: DocumentPhase[] = [
  {
    id: "start",
    label: "Start",
    rules: [
  ...
  },
  {
    ...
    rules: [
      ...
      {
        title:
          "Addendum for Property Subj. to Mand. Membership in Owners Assoc.",
        setting: "Required",
        where: "HOAP",
        except: "BLDP",
        phaseLabel: "Contract",
...
export default function DocumentsBuyerPage({ userEmail }: DocumentsProps) {
  const phases = SALE_BUYER_ACTIVE_DISPLAYED;
    ...
    <AppShell userEmail={userEmail} activeTab="Start">
      <div>
        ...
        <p style={pageSubTitleStyle}>
          ...
          <strong>Residential Sale · Buyer · Active · Displayed</strong>.
        </p>
        ...
        <div style={mainCardStyle}>
          ...
          <section style={mainAreaStyle}>
            ...
            >
              ...
              >
                ✅ Profile: Buyer · Active · Displayed
              </div>
            </div>
